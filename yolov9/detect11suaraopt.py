...
def wait_for_conditions(engine):
    while True:
        ...
        if message == "Tunggu satu menit.":
            break
        #playsound("/home/jetson/Downloads/videoplayback.m4a")
        time.sleep(0.5)  # Wait for half a second before rechecking
            ...
            if len(det):
                ...
                for c, count in class_counts.items():
                    if names[int(c)] == 'Neozep Forte':
                        # Play the audio file
                        playsound("/home/jetson/Music/Startup_sound/startup.mp3")
                        ...
                        text_to_speak += "Paramex adalah pereda nyeri umum dan penurun demam. Sebaiknya diminum dengan air setelah makan"
                    # Tambahkan else if lainnya sesuai kebutuhan
                    else:
