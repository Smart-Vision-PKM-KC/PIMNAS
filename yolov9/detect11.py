    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                engine.setProperty('voice','id+f1')
                if names[int(c)] == 'Intunal F':
                    text_to_speak += "Intunal F merupakan obat penurun panas, konsumsi 3 kali sehari setelah makan"
                elif names[int(c)] == 'Paramex':
                    text_to_speak += "Paramex oieoagnein is a common pain reliever and fever reducer. It should be taken with water, preferably after s "
