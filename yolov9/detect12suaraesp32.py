...
def run(
    ...
    wait_for_conditions()
    time.sleep(0.5)  # Wait for 1 minute
    ...
    first_time = True  # Add flag for first time
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            # Implement logic to only play sound first time
            if first_time == True:
                playsound("/home/jetson/Documents/PKM/obat_sound/ready.mp3")  # Play sound when camera is active
                first_time = False
